...
`9a959f142f6660f4a736174cb17f8bea6ff332c1`. This revision carries the bounded FileLease lifecycle,
...
```sh
git -C ../linguamesh-core cat-file -e 9a959f142f6660f4a736174cb17f8bea6ff332c1^{commit}
git -C ../linguamesh-core diff --quiet \
  9a959f142f6660f4a736174cb17f8bea6ff332c1..HEAD -- \
...
`9a959f142f6660f4a736174cb17f8bea6ff332c1`, installs the headers plus D-Bus, Xvfb, test-only
