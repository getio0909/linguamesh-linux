...
`8b096475b00fbb4b8f5c88db3d6c7f35d7e046b9`. This revision carries the bounded FileLease lifecycle,
...
```sh
git -C ../linguamesh-core cat-file -e 8b096475b00fbb4b8f5c88db3d6c7f35d7e046b9^{commit}
git -C ../linguamesh-core diff --quiet \
  8b096475b00fbb4b8f5c88db3d6c7f35d7e046b9..HEAD -- \
...
`8b096475b00fbb4b8f5c88db3d6c7f35d7e046b9`, installs the headers plus D-Bus, Xvfb, test-only
