...
`e207754a35d9e29b8716420e1d19f755c9e27682`. This revision carries the explicit request-level
...
```sh
git -C ../linguamesh-core cat-file -e e207754a35d9e29b8716420e1d19f755c9e27682^{commit}
git -C ../linguamesh-core diff --quiet \
  e207754a35d9e29b8716420e1d19f755c9e27682..HEAD -- \
