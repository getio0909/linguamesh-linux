...
`c559b32d3869e01983f2bbf32f1386bad99c3290`. This revision carries the explicit request-level
...
```sh
git -C ../linguamesh-core cat-file -e c559b32d3869e01983f2bbf32f1386bad99c3290^{commit}
git -C ../linguamesh-core diff --quiet \
  c559b32d3869e01983f2bbf32f1386bad99c3290..HEAD -- \
...
`c559b32d3869e01983f2bbf32f1386bad99c3290`, installs the headers plus D-Bus, Xvfb, test-only
