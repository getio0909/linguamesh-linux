...
`5feaa3700764e3f174a69a4b490ae67b2d5cd8c9`. This revision carries the explicit request-level
...
```sh
git -C ../linguamesh-core cat-file -e 5feaa3700764e3f174a69a4b490ae67b2d5cd8c9^{commit}
git -C ../linguamesh-core diff --quiet \
  5feaa3700764e3f174a69a4b490ae67b2d5cd8c9..HEAD -- \
...
Markdown, CSV, SRT, and WebVTT, preserves line endings, keeps Markdown fenced code and subtitle timing
