...
`530e6ea75ef3ccba5defd264227fb6dd6802e17a`. This revision carries bounded document lease
...
```sh
git -C ../linguamesh-core cat-file -e 530e6ea75ef3ccba5defd264227fb6dd6802e17a^{commit}
git -C ../linguamesh-core diff --quiet \
  530e6ea75ef3ccba5defd264227fb6dd6802e17a..HEAD -- \
...
python3 tools/create-native-evidence.py \
  ...
  --core-revision "530e6ea75ef3ccba5defd264227fb6dd6802e17a" \
