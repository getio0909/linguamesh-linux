...
Open, Translate, Retry, fallback-consent, and Stop controls with their expected roles, plus two exported
text-editor roles. The GTK unit test also verifies that document
