...
Open, Translate, Retry, fallback-consent, and Stop controls with their expected roles, plus status
and alert semantic roles and two exported text-editor roles. The GTK unit test also verifies that document
