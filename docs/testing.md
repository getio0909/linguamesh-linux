...
`8790eb41a52c4e2c908044699e8c12597d3c42a5`. This revision carries the explicit request-level
...
```sh
git -C ../linguamesh-core cat-file -e 8790eb41a52c4e2c908044699e8c12597d3c42a5^{commit}
git -C ../linguamesh-core diff --quiet \
  8790eb41a52c4e2c908044699e8c12597d3c42a5..HEAD -- \
...
`8790eb41a52c4e2c908044699e8c12597d3c42a5`, installs the headers plus D-Bus, Xvfb, test-only
