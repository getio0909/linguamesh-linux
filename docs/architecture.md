...
switches translated action, workspace-widget, active-provider, status summary/partial-output, text-file import, provider-profile, source/target language, editor text-metrics, and routing preference/privacy/document constraints plus onboarding stage/detail controls and System/Light/Dark theme
