...
functional revision is `08eb64c6f8c94e7c7c4d3d0edb1eb37f0e1dcfb0`; compared with the prior
...
The native text-file path delegates TXT/Markdown/CSV/JSON/HTML/SRT/WebVTT/DOCX format detection and bounded UTF-8/BOM handling to
...
source/target locales, provider/model IDs, and optional glossary rules. Imported TXT/Markdown/CSV/JSON/HTML/SRT/WebVTT/DOCX files
...
reuse saved options only after the active runtime matches. DOCX package resources remain intact while
