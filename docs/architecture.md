...
switches translated action, workspace-widget, active-provider, status summary/partial-output, text-file import, provider-profile, and source/target language controls plus System/Light/Dark theme
