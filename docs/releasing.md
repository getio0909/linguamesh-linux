...
and headless delivery to a real `dunst` notification daemon under Xvfb, but no interactive
file-chooser portal, physical desktop notification rendering, signed artifact, or
