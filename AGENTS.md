...
`b54ab4ab7ebcd3a439678ead9c0af1e6b5c5dae8`; changing it requires a new compatibility review. This
adds ABI 1 opaque engine-handle lifetime hardening while preserving the Linux runtime contract. Do not
