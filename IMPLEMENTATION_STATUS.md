...
- Local `cargo deny --manifest-path Cargo.toml --all-features check --config=deny.toml advisories bans
  licenses sources` passed. It reports duplicate `getrandom`, `hashbrown`, and `windows-sys`
