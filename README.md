...
reviewed Core functional revision `9926d0f9bf6394c6011c6cc886d142bfeb54e10f`, which adds strict
...
`b871a881f0eaf88cdda67a50f9221375f4c814ce` and validated with `msgfmt`; the 377-message bundle
adds Linux routing-profile persistence/editor, profile-ID validation and duplicate protection, ordinary-text selection labels, routing preference/privacy/document constraints, and source/output character plus approximate-token metrics. The locale selector
