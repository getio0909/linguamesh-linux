...
reviewed Core functional revision `ae8e437ff51fb045a6961604db6a19ebe488e0ba`, which adds
...
SRT/WebVTT/CSV/JSON document contract with preserved line endings, verbatim Markdown fences, and validated
subtitle timing, plus schema-9 document job snapshots that survive worker restart without persisting source paths or credentials, plus
...
Use **Open text file** to load a UTF-8 TXT, Markdown, CSV, JSON, SRT, or WebVTT file into the source editor. The native
...
Each successful TXT, Markdown, CSV, JSON, SRT, or WebVTT import is also stored as a bounded Core document job.
**Translate**
