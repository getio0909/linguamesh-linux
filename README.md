...
reviewed Core revision `e0b682fa183cfdebfabc0ef04d531c58031d8e85`, which adds bounded XLSX
sheet/range selection on top of the bundled `unix-none` fail-closed storage regression, existing
`unix-excl`, and ABI 1
